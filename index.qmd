...
|-----------|-------------|
| dNDBI 2021–2024 | Built-up signal change. \( \text{NDBI} = \frac{SWIR - NIR}{SWIR + NIR} \), and \( \Delta \text{NDBI} = \text{NDBI}_{2024} - \text{NDBI}_{2021} \). |
| dNDVI 2021–2024 | Vegetation/greenness change. \( \text{NDVI} = \frac{NIR - Red}{NIR + Red} \), and \( \Delta \text{NDVI} = \text{NDVI}_{2024} - \text{NDVI}_{2021} \). |
| dNTL 2021–2024 | Night-time light radiance change. \( \Delta \text{NTL} = \text{NTL}_{2024} - \text{NTL}_{2021} \). |
